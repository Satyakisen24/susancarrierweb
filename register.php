...
$headers =	"From: me.chiranjibdey@gmail.com\r\n";
...
$file =	 file_get_contents("http://susancarrier.com/header.png");
 	 
$message .=	"Content-Type: image/png; name=\"header.png\"\r\n"
 	."Content-Transfer-Encoding: base64\r\n"
 	."Content-disposition: attachment; file=\"header.png\"\r\n"
 	."\r\n"
 	.chunk_split(base64_encode($file))
 	.$bound_last;
                
                
				mail($Email, 'Thank you For Registring with us', $message, $headers);
...
<div class="top_part">
    ...
    <div class="call_us">Call Us: <br /><strong>0411 839 534</strong>
</div>
