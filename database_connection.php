...
DEFINE('DATABASE_USER', 'susancn5_susan');
DEFINE('DATABASE_PASSWORD', 'sus@123');
DEFINE('DATABASE_HOST', 'localhost');
DEFINE('DATABASE_NAME', 'susancn5_mail');
